...
/* APPLICATION > FRONTEND > PAGES > ADMIN > LOGIN > DEFAULT */

class application_frontend_pages_admin_login_default
{
	public static function run()
	{
		...
		return engine_frontend_genhtml::run($data, "/application/code/frontend/pages/admin/login/default/screen.template.html");
	}
